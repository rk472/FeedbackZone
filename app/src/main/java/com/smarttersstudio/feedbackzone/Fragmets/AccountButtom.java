...
public class AccountButtom extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root=inflater.inflate(R.layout.fragment_account_buttom, container, false);
        submitButton=root.findViewById(R.id.account_submit);
        feedBackText=root.findViewById(R.id.account_feedback);
        feedbackRef= FirebaseDatabase.getInstance().getReference().child("feedback").child("accounts");
        ...
        rateRef=FirebaseDatabase.getInstance().getReference().child("rating").child("accounts");
        totalRef=FirebaseDatabase.getInstance().getReference().child("total").child("accounts");
        mAuth= FirebaseAuth.getInstance();
        final String uid=mAuth.getCurrentUser().getUid();
        r1=root.findViewById(R.id.accounts_radio_1);
        r2=root.findViewById(R.id.accounts_radio_2);
        r3=root.findViewById(R.id.accounts_radio_3);
        rb=root.findViewById(R.id.accounts_rate);
        updateButton=root.findViewById(R.id.account_update_button);
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(rr1==null ||rr2==null ||rr3==null || rate1.equals("0")){
                    Toast.makeText(getActivity(), "All questions must be answered", Toast.LENGTH_SHORT).show();
                }else{
                    String salary=rr1.getText().toString();
                    String helpful=rr2.getText().toString();
                    String finance=rr3.getText().toString();
                    Map m=new HashMap();
                    m.put("salary",salary);
        ...
        rateRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if(dataSnapshot.hasChild(uid)){
                    String polite=dataSnapshot.child(uid).child("salary").getValue().toString();
